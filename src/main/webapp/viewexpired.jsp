        	...
        	e.printStackTrace();
       		...
       		%>
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <h6 class="mb-4">Medicines Expiring Today</h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                     <%  					        	
										try{
										Connection con=ConnectDB.connect();
										PreparedStatement ps=con.prepareStatement("select * from medicines where email=? and expired='Yes' order by medstatus");
										ps.setString(1, Memail.getmEmail());
										ResultSet rs=ps.executeQuery();
										while(rs.next()){
									%>
