                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10"></h5>
                                            <h2 class="m-b-10">Welcome to Med <i class="fa fa-medkit text-c-green"></i> Guardian</h2>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">All Medicals</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                 ...
                 <div class="page-body">
                   <div class="row">
                        ...
                        <div class="bg- rounded h-100 p-4">
                            <h6 class="mb-4">All Medical List</h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                     <%  try{					        	
										...
										PreparedStatement ps=con.prepareStatement("select mid,mname, mloc,mcinfo,mctgry,mowner,mlic,mbtype,mhystandards, status from medical order by status desc");
									...
									%>
                                        <tr>
                                            ...
                                            <td class="text-c-blue"><%=rs.getString(10)%></td>
                                            <!-- <td><a href="approvem.jsp?id=<%--=rs.getInt(1)--%>"><i class="text-c-green">Approve</i></a></td> -->
                                            <td><a href="deletem.jsp?id=<%=rs.getInt(1)%>"><i class="text-c-red">Delete</i></a></td>
                                        </tr>
