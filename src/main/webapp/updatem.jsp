                                        ...
                                        <li class=" ">
                                         ...
                                         <li class="active">
                                            <a  class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Update Medicines</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                           <li class=" ">
                                                    ...
                                                    <div class="card-block">
                                                        <h4 class="sub-title"><b>Medicines Details</b></h4>
                                                            ...
                                                            try{
                                                            	...
                                                            	Connection con=ConnectDB.connect();
																PreparedStatement ps=con.prepareStatement("select medid,medprice,medqty,meddisc from medicines where medid=? and email=?");
																ps.setString(1, medid);
																ps.setString(2, Memail.getmEmail());
																ResultSet rs=ps.executeQuery();
																if(rs.next()){
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="medid" value="<%=rs.getInt(1)%>" class="form-control form-control-round form-control-success" required>
                                                                </div>
                                                            </div>
                                                             ...
                                                             <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="medprice" value="<%=rs.getInt(2)%>" class="form-control form-control-round form-control-success" maxlength="5"  required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="medqty" value="<%=rs.getInt(3)%>" class="form-control form-control-round form-control-success" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <button class="btn waves-effect waves-light btn-success btn-outline-success" type="submit"><i class="icofont icofont-check-circled"></i>Update Medicine</button>
                                                        </form>     
                                                        </div>
                                                        <%  
														}}catch(Exception e){
