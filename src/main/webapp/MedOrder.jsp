								...
								<div class="page-body">
									<div class="row">
										<div class="col-12">
											...
											try {
												Connection con = ConnectDB.connect();
												String query = "SELECT medid,medname,medimg,medbname,medprice,medctgry,medstatus,meddisc,medexdate,email from medicines where expired='No' and medstatus='Unvailable' and email=? order by nearexpire";

												PreparedStatement stmt = con.prepareStatement(query);
												stmt.setString(1,Memail.getmEmail());
