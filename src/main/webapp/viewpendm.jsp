                ...
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Pending Medical List</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="bg- rounded h-100 p-4">
                            <h6 class="mb-4">Pending Medicals Regitration</h6>
                                ...
                                <table class="table">
                                    ...
                                    <%  
                                       try{					        	
										...
										PreparedStatement ps=con.prepareStatement("select mid,mname, mloc,mcinfo,mctgry,mowner,mlic,mbtype,mhystandards, status from medical where status='Pending'");
									...
									%>
                                        <tr>
                                            ...
                                            <td><%=rs.getString(9)%></td>
                                       		<td><i class="fa fa-times text-c-red"></i></td>
