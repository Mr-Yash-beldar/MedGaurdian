				...
				<div class="pcoded-wrapper">
					<nav class="pcoded-navbar">
						...
						<div class="pcoded-inner-navbar main-menu">
							...
							<ul class="pcoded-item pcoded-left-item">
								<li class="pcoded-hasmenu pcoded-trigger "><a
							...
							<ul class="pcoded-item pcoded-left-item">
								<li class="pcoded-hasmenu active"><a href="javascript:void(0)"
									class="waves-effect waves-dark"> <span class="pcoded-micon"><i
								...
								<div class="page-body">
									<div class="row">
										<div class="col-12">
											...
											try {
												Connection con = ConnectDB.connect();
												String query = "SELECT medid,medname,medimg,medbname,medprice,medctgry,medstatus,meddisc,medexdate,email from medicines where expired='No' and medstatus='Unavailable' order by nearexpire";
